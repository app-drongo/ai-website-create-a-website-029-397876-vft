        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          <div className="flex justify-center mb-8">
            <button
              ...
              className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-sm font-medium text-primary hover:bg-primary/20 transition-colors"
            >
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Harness the power of artificial intelligence to analyze your business data, uncover
              hidden patterns, and make data-driven decisions with confidence.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Button
                size="lg"
                className="bg-primary text-primary-foreground group text-base px-8"
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-primary text-primary group text-base px-8"
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2">
                  ...
                  <div className="size-8 rounded-full bg-primary/80 border-2 border-background" />
                  <div className="size-8 rounded-full bg-primary/60 border-2 border-background" />
                </div>
                <span className="ml-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="ml-2">4.9/5 on G2 Crowd</span>
              </div>
            </div>
          </div>
              ...
              <div className="rounded-2xl border border-primary/20 bg-card p-2 shadow-2xl">
                <div className="rounded-xl bg-gradient-to-br from-primary/5 to-primary/10 aspect-video flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-primary">Watch Platform Demo</p>
                  </div>
                </div>
              </div>
